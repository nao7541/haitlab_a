# Generated by Django 3.0.6 on 2020-11-26 05:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prof_img', models.ImageField(blank=True, null=True, upload_to='user/', verbose_name='プロフィール画像')),
        ...
        migrations.CreateModel(
            name='Skill',
            fields=[
                ('skill_id', models.AutoField(primary_key=True, serialize=False, verbose_name='スキルID')),
                ('skill_name', models.CharField(max_length=20, verbose_name='スキル名')),
                ('skill_level', models.CharField(blank=True, max_length=20, null=True, verbose_name='持っているスキルのレベル')),
